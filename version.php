...
$plugin->version   = 2018112633;                     // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '1.1.2-33.0'; // Pattern: [major].[minor].[patch]-[Moodle Version].[Moodle version specific patch].
